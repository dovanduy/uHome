...
import com.bonree.touchserver.wrappers.ServiceManager;
...
public class TouchEventServer {
    ...
    private TouchEventServer(int r6, int r7) throws IOException {
        /*
            ...
            com.bonree.touchserver.LogUtil.d(r0)     // Catch:{ IOException -> 0x006f, all -> 0x006d }
            android.net.LocalSocket r0 = r1.accept()     // Catch:{ IOException -> 0x006f, all -> 0x006d }
            java.lang.String r2 = "client bind SUCCESS !"
            com.bonree.touchserver.LogUtil.d(r2)     // Catch:{ IOException -> 0x006f, all -> 0x006d }
            com.bonree.touchserver.wrappers.ServiceManager r2 = new com.bonree.touchserver.wrappers.ServiceManager     // Catch:{ IOException -> 0x006f, all -> 0x006d }
            ...
            com.bonree.touchserver.Screenshot r7 = new com.bonree.touchserver.Screenshot     // Catch:{ IOException -> 0x006f, all -> 0x006d }
            com.bonree.touchserver.wrappers.ServiceManager r2 = r5.mServiceManager     // Catch:{ IOException -> 0x006f, all -> 0x006d }
        ...
        L_0x0046:
            ...
            com.bonree.touchserver.ScreenEncoder r3 = new com.bonree.touchserver.ScreenEncoder     // Catch:{ IOException -> 0x006f, all -> 0x006d }
        ...
        L_0x0088:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bonree.touchserver.TouchEventServer.<init>(int, int):void");
    }
