...
import com.uhome.commonlib.update.UpdateManager;
...
public abstract class BaseLauncherActivity extends AppCompatActivity {
    ...
    protected abstract String initVersionName();

    protected abstract int initVersionCode();

    protected abstract String initFirAppId();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTips();
//        UpdateService.startService(this,initFirAppId(),initVersionCode());
//        UpdateManager.getInstance().start(this,initFirAppId(),initVersionCode());

    }

    protected void initTips() {
        final TextView appVersion = findViewById(R.id.app_version);
        appVersion.setText("APP版本：" + initVersionName());
